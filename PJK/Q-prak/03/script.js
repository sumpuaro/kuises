(function(){
  ...
  function validateAccess() {
    const now = new Date();
    const startTime = new Date('2023-09-11T10:00:00');
    const endTime = new Date('2025-09-11T10:30:00');
  ...
  function sendResultToGoogleSheet(fullName, nim, score) {
      ...
      const data = {
          ...
          nim: nim,
          score: score,
          quizTitle: `${quizId} Praktikum Pengindraan Jauh Kehutanan`,
          date: date,
          time: time
      };
  ...
  document.addEventListener('DOMContentLoaded', function() {
      ...
      if (quizInfoElement) {
          quizInfoElement.textContent = `${quizId}. Semoga Sukses.`;
      }
